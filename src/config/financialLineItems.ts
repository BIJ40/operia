...
export const PL_SECTIONS: PLSection[] = [
  ...
  // ════════════ CHARGES EXTERNES ════════════
  {
    ...
    items: [
      ...
      { key: 'externe_redevances_hc_assistance', label: 'Redevances HC assistance', source_type: 'manual_variable', charge_key: 'externe_redevances_hc_assistance', indent: 1, autoSource: 'royalty' },
      { key: 'externe_redevances_hc_fcn', label: 'Redevances HC FCN', source_type: 'manual_variable', charge_key: 'externe_redevances_hc_fcn', indent: 1, autoSource: 'royalty' },
