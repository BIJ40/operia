...
export const PAGE_HEADER_MATCHERS: PageHeaderConfig[] = [
  ...
  { match: (path) => path === '/projects/auto-classify', pageKey: 'projects_auto_classify', defaultTitle: 'Auto-Classeur IA', defaultSubtitle: 'Classification automatique des tickets par intelligence artificielle', icon: 'Sparkles', parentRoute: '/projects', parentLabel: 'Projet' },
