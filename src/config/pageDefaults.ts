...
export const PAGE_HEADER_MATCHERS: PageHeaderConfig[] = [
  ...
  { match: (path) => path === '/hc-agency/statistiques', pageKey: 'pilotage_statistiques', defaultTitle: 'Statistiques', defaultSubtitle: 'Accédez à l\'ensemble des indicateurs de votre agence', icon: 'PieChart', parentRoute: '/hc-agency', parentLabel: 'Mon Agence' },
  ...
  { match: (path) => path === '/hc-agency/statistiques/diffusion', pageKey: 'pilotage_diffusion', defaultTitle: 'Mode Diffusion', defaultSubtitle: 'Affichage TV pour l\'agence', icon: 'Tv', parentRoute: '/hc-agency/statistiques', parentLabel: 'Statistiques' },
  ...
  { match: (path) => path === '/faire-une-demande', pageKey: 'faire_une_demande', defaultTitle: 'Faire une demande', defaultSubtitle: 'Demandez un document RH', icon: 'Send', parentRoute: '/', parentLabel: 'Accueil' },
