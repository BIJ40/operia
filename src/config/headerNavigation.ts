...
export const HEADER_NAV_GROUPS: HeaderNavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Apporteurs', icon: Handshake, tab: 'organisation', description: "Réseau d'apporteurs", scope: 'relations.apporteurs', subTabKey: 'organisation_sub_tab', subTabValue: 'apporteurs' },
      ...
      { label: 'Échanges apporteurs', icon: MessagesSquare, tab: 'organisation', description: 'Fil de discussion avec les apporteurs', scope: 'relations.apporteurs', subTabKey: 'organisation_sub_tab', subTabValue: 'echanges-apporteurs' },
    ],
  },
  {
    label: 'Documents',
