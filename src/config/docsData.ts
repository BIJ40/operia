...
export const MODULES_DOCS: ModuleDoc[] = [
  ...
  },
  {
    ...
    routes: ['/hc-agency', '/hc-agency/indicateurs/*', '/diffusion'],
  ...
  },
  {
    ...
    routes: ['/hc-agency/parc', '/hc-agency/equipements'],
...
export const TABLE_CATEGORIES = [
  ...
  { id: 'messaging', name: 'Messagerie', tables: ['conversations', 'conversation_members', 'messages'] },
