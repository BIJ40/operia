...
export const MODULE_DEFINITIONS: ModuleDefinition[] = [
  ...
  {
    key: 'pilotage.statistiques',
    label: 'Statistiques',
    description: 'Tableaux statistiques détaillés',
    icon: 'BarChart3',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  {
    key: 'pilotage.statistiques.general',
    label: 'Général',
    description: 'Vue statistique générale',
  ...
  {
    key: 'pilotage.statistiques.apporteurs',
    label: 'Apporteurs',
  ...
  {
    key: 'pilotage.statistiques.techniciens',
    label: 'Techniciens',
  ...
  {
    key: 'pilotage.statistiques.univers',
    label: 'Univers',
  ...
  {
    key: 'pilotage.statistiques.previsionnel',
    label: 'Prévisionnel',
    description: 'Statistiques prévisionnelles',
    icon: 'TrendingUp',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  {
    key: 'pilotage.statistiques.financier',
    label: 'Financier',
  ...
  {
    key: 'pilotage.statistiques.exports',
    label: 'Exports',
    description: 'Exports statistiques',
    icon: 'Download',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  {
    key: 'pilotage.performance',
    label: 'Performance',
    description: 'Suivi de performance agence',
    icon: 'TrendingUp',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  {
    key: 'pilotage.incoherences',
    label: 'Incohérences',
    description: 'Détection des incohérences données',
    icon: 'AlertTriangle',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  {
    key: 'pilotage.tresorerie',
    label: 'Trésorerie',
    description: 'Suivi et prévisions de trésorerie',
    icon: 'Wallet',
    category: 'pilotage',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  },
  {
    ...
    description: 'Documents réglementaires et légaux',
    icon: 'FileCheck',
    category: 'organisation',
    defaultForRoles: ['franchisee_admin', 'platform_admin', 'superadmin'],
    minRole: 'franchisee_admin',
  ...
  },
  {
    key: 'support.faq',
    label: 'FAQ',
    description: 'Questions fréquentes et base de connaissances',
    icon: 'HelpCircle',
    category: 'support',
    defaultForRoles: ['franchisee_admin', 'franchisor_user', 'franchisor_admin', 'platform_admin', 'superadmin'],
    minRole: 'base_user',
