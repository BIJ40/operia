 ...
 * V1 : ~65 entrées couvrant les 12 mois.
 */
...
export const AWARENESS_DAYS: AwarenessDay[] = [
  ...
  { month: 1, day: 20, label: "Journée du gros pull — Chauffage & économies", tags: ['energie', 'confort', 'habitat'], relevanceDomains: ['energie', 'confort'], priorityScore: 70, contentTypeHint: 'pedagogique', preferredUniverses: ['plomberie', 'electricite'], ctaHint: 'optimisation_chauffage' },
  { month: 1, day: 28, label: "Journée protection des données — Sécurité domotique", tags: ['securite', 'electricite'], relevanceDomains: ['securite'], priorityScore: 60, contentTypeHint: 'pedagogique', preferredUniverses: ['electricite'], ctaHint: 'securite_domotique' },
  ...
  { month: 2, day: 20, label: "Journée justice sociale — Accès au logement décent", tags: ['habitat', 'renovation'], relevanceDomains: ['habitat', 'renovation'], priorityScore: 65, contentTypeHint: 'engagement', preferredUniverses: ['renovation', 'pmr'], ctaHint: 'renovation_solidaire' },
  { month: 2, day: 25, label: "Fin hiver — Bilan consommation énergétique", tags: ['energie', 'entretien'], relevanceDomains: ['energie'], priorityScore: 75, contentTypeHint: 'pedagogique', preferredUniverses: ['electricite', 'plomberie'], ctaHint: 'bilan_conso_hiver' },
  ...
  { month: 3, day: 15, label: "Journée des droits des consommateurs", tags: ['engagement', 'habitat'], relevanceDomains: ['habitat'], priorityScore: 60, contentTypeHint: 'engagement', preferredUniverses: ['general'], ctaHint: 'transparence_devis' },
  ...
  { month: 4, day: 12, label: "Journée de la sécurité incendie", tags: ['securite', 'electricite'], relevanceDomains: ['securite'], priorityScore: 80, contentTypeHint: 'prevention', preferredUniverses: ['electricite'], ctaHint: 'verification_installation_electrique' },
  ...
  { month: 5, day: 5, label: "Journée de l'hygiène des mains — Sanitaires propres", tags: ['eau', 'entretien', 'plomberie'], relevanceDomains: ['entretien'], priorityScore: 60, contentTypeHint: 'pedagogique', preferredUniverses: ['plomberie'], ctaHint: 'entretien_sanitaires' },
  ...
  { month: 5, day: 20, label: "Journée mondiale des abeilles — Jardins & habitat", tags: ['habitat', 'entretien'], relevanceDomains: ['habitat'], priorityScore: 55, contentTypeHint: 'engagement', preferredUniverses: ['general'], ctaHint: 'habitat_nature' },
  ...
  { month: 6, day: 10, label: "Début saison orages — Protection électrique", tags: ['securite', 'electricite', 'urgence'], relevanceDomains: ['securite', 'urgence'], priorityScore: 80, contentTypeHint: 'prevention', preferredUniverses: ['electricite'], ctaHint: 'parafoudre_protection' },
  ...
  { month: 7, day: 10, label: "Pic chaleur — Isolation & ventilation", tags: ['confort', 'energie', 'renovation'], relevanceDomains: ['confort', 'energie'], priorityScore: 80, contentTypeHint: 'pedagogique', preferredUniverses: ['renovation', 'plomberie'], ctaHint: 'isolation_thermique' },
  ...
  { month: 7, day: 28, label: "Journée de la nature — Entretien extérieur", tags: ['entretien', 'habitat'], relevanceDomains: ['habitat', 'entretien'], priorityScore: 60, contentTypeHint: 'engagement', preferredUniverses: ['general'], ctaHint: 'entretien_exterieur' },
  ...
  { month: 8, day: 10, label: "Sécurité piscine & eau — Prévention noyade", tags: ['securite', 'eau', 'plomberie'], relevanceDomains: ['securite'], priorityScore: 65, contentTypeHint: 'prevention', preferredUniverses: ['plomberie'], ctaHint: 'securite_eau' },
  ...
  { month: 8, day: 22, label: "Journée de l'énergie — Bilan conso été", tags: ['energie'], relevanceDomains: ['energie'], priorityScore: 70, contentTypeHint: 'pedagogique', preferredUniverses: ['electricite'], ctaHint: 'bilan_energie_ete' },
  { month: 8, day: 28, label: "Rentrée approche — Vérification sécurité domicile", tags: ['securite', 'serrurerie', 'entretien'], relevanceDomains: ['securite', 'entretien'], priorityScore: 75, contentTypeHint: 'prevention', preferredUniverses: ['serrurerie', 'electricite'], ctaHint: 'check_securite_rentree' },
  ...
  { month: 9, day: 10, label: "Journée du patrimoine — Entretien bâti ancien", tags: ['renovation', 'habitat'], relevanceDomains: ['renovation', 'habitat'], priorityScore: 70, contentTypeHint: 'pedagogique', preferredUniverses: ['renovation', 'menuiserie'], ctaHint: 'renovation_patrimoine' },
  ...
  { month: 9, day: 26, label: "Journée européenne des langues — Notre équipe multiculturelle", tags: ['engagement'], relevanceDomains: ['habitat'], priorityScore: 55, contentTypeHint: 'local_branding', preferredUniverses: ['general'], ctaHint: 'diversite_equipe' },
  ...
  { month: 10, day: 5, label: "Journée des enseignants — Maintenance écoles", tags: ['entretien', 'habitat'], relevanceDomains: ['entretien'], priorityScore: 55, contentTypeHint: 'engagement', preferredUniverses: ['general'], ctaHint: 'maintenance_batiments' },
  ...
  { month: 10, day: 20, label: "Journée de la statistique — Nos chiffres clés", tags: ['engagement'], relevanceDomains: ['habitat'], priorityScore: 55, contentTypeHint: 'local_branding', preferredUniverses: ['general'], ctaHint: 'chiffres_cles_agence' },
  ...
  { month: 11, day: 12, label: "Journée de la gentillesse — Témoignages clients", tags: ['engagement', 'habitat'], relevanceDomains: ['habitat'], priorityScore: 60, contentTypeHint: 'local_branding', preferredUniverses: ['general'], ctaHint: 'avis_clients' },
  ...
  { month: 11, day: 20, label: "Journée de l'enfant — Sécurité domestique enfants", tags: ['securite', 'habitat'], relevanceDomains: ['securite', 'habitat'], priorityScore: 75, contentTypeHint: 'prevention', preferredUniverses: ['electricite', 'plomberie'], ctaHint: 'securite_enfants' },
  ...
  { month: 12, day: 5, label: "Journée du bénévolat — Notre engagement local", tags: ['engagement'], relevanceDomains: ['habitat'], priorityScore: 55, contentTypeHint: 'local_branding', preferredUniverses: ['general'], ctaHint: 'engagement_local' },
  ...
  { month: 12, day: 15, label: "Journée du thé — Pause bien méritée nos artisans", tags: ['engagement'], relevanceDomains: ['habitat'], priorityScore: 50, contentTypeHint: 'local_branding', preferredUniverses: ['general'], ctaHint: 'vie_equipe' },
