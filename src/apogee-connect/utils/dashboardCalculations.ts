...
// ====================================================================
export { isRT, isDepannage, isTravaux, isSav } from "./interventionUtils";
export { isParticulier, isApporteur } from "./projectUtils";

// Import local pour usage interne
import { isRT } from "./interventionUtils";
