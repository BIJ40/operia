...
const MODULES: ModuleSlide[] = [
  ...
  },
  {
    ...
    title: 'Suivi Client',
    icon: UserCheck,
    screenshot: ['/images/screenshots/suiviclient.png', '/images/screenshots/suiviclient2.png'],
  ...
  },
  {
    ...
    title: 'Paiements',
    icon: CreditCard,
    screenshot: ['/images/screenshots/paiement.png', '/images/screenshots/paiement2.png'],
