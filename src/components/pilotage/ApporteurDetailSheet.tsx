...
import { Building2, Users, ExternalLink, Check, X, Info, Link2, Link2Off, Archive, Trash2, Plus, Mail, UserPlus, Globe, Pencil } from 'lucide-react';
import { Apporteur, useToggleApporteurStatus, useApporteurManagers, useCreateApporteurManager, useToggleApporteurManagerStatus, useDeleteApporteurManager, useUpdateApporteurManager, useUpdateApporteurApogeeId, useDeleteApporteur, useTogglePortalEnabled } from '@/hooks/useApporteurs';
