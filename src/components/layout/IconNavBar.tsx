...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { title: 'Mes Indicateurs', url: ROUTES.agency.statsHub, icon: PieChart },
      { title: 'Actions à Mener', url: ROUTES.agency.actions, icon: ListTodo },
      { title: 'Commercial', url: ROUTES.agency.commercial, icon: BarChart3 },
      { title: 'Diffusion', url: ROUTES.agency.diffusion, icon: Tv },
      { title: 'Validation plannings', url: ROUTES.agency.rhTech, icon: Calendar },
    ],
