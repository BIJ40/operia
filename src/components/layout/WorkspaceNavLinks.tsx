...
export function WorkspaceNavLinks({ activeTab }: WorkspaceNavLinksProps) {
  ...
  const allTabs: TabConfig[] = useMemo(() => [
    ...
    { id: 'commercial', label: getShortLabel('commercial', 'Commercial'), icon: ShoppingCart, requiresOption: { module: 'commercial.prospects' }, altModules: ['commercial.realisations', 'commercial.social'] },
