/**
 * CoffreRHWidget - Widget avec cadran de coffre-fort qui remplit tout l'espace
 */
...
export function CoffreRHWidget() {
  ...
  return (
    <div 
      className="absolute inset-0 flex items-center justify-center cursor-pointer hover:bg-helpconfort-blue/5 transition-colors group"
      onClick={() => navigate('/mon-coffre-rh')}
    >
      {/* Cadran de coffre-fort - remplit tout l'espace disponible */}
      <svg 
        viewBox="0 0 100 100" 
