// Page identique à ApporteursNationaux.tsx avec un titre différent
  ...
  return (
    ...
    >
      ...
      {editingId === category.id ? (
        ...
        <Link to={`/informations-utiles/category/${category.slug}`}>
...
export default function InformationsUtiles() {
  ...
  useEffect(() => {
    if (categories.length >= 0) {
      localStorage.setItem('informationsUtilesData', JSON.stringify({ categories }));
    }
  }, [categories]);
