 ...
 * Mode tournée: quand 1 seul tech sélectionné → numéros + trajet routier
 */
...
export default function RdvMapPage() {
  ...
  // Route coords for directions API
