  ...
  return (
    <>
      <div className="container max-w-4xl mx-auto p-8">
        <Link to="/apogee" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-6">
          <Icons.ArrowLeft className="w-4 h-4" />
          <span>Retour vers le Guide</span>
        </Link>
