...
import { PhotoPV } from '../types';
import { cn } from '@/lib/utils';

interface PhotosPVSectionProps {
  photos: PhotoPV[];
  onChange: (photos: PhotoPV[]) => void;
}

export function PhotosPVSection({ photos, onChange }: PhotosPVSectionProps) {
