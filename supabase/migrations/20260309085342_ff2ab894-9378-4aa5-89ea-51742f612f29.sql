...
-- Fix auto_create_collaborator trigger to detect existing collaborators by email
-- before creating duplicates. If found, link the user_id instead of inserting.
