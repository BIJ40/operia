...
-- ============================================================
-- RPC PATCHÉ — get_user_effective_modules
-- FIX A : path NONE pour modules hors plan
-- FIX B : suppression filtre role_level >= 2
-- FIX C : JOIN validation sur module_registry (ghost keys)
-- FIX D : contrainte plan sur overrides individuels
-- ============================================================
...
BEGIN
  ...
  user_override_expanded AS (
    ...
    JOIN module_registry mr_check ON mr_check.key = um.module_key
